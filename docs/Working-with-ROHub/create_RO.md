...
Filling the basic information is sufficient to create a RO in the ROHub platform, but the user can continue enriching the RO with other metadata or simply create the basic RO and exit by clicking "Create and Exit" . On clicking “Create and Continue '' present at the bottom right of this page the user can create the RO and also simultaneously navigate through other forms to add the various relevant metadata in order to enrich the research object. The user can always come back again later to edit the metadata of the newly created RO listed in the My ROs section. "Reset form" allows the user to reset the basic information form and provide inputs again. Once the RO is created with the basic information the newly created RO can be accessed from the Explore page of the ROHub also. The user can continue to add additional metadata during the creation process or edit the RO later by clicking the edit option from the RO toolbox. The below mentioned sections are the additional metadata the user can add to enrich a RO.
...
<p align="center"> <img src="https://box.psnc.pl/f/e5c9ef2d7d/?raw=1" width="600"> </p>
...
<p align="center"> <img src="https://box.psnc.pl/f/9801d3117b/?raw=1" width="600"> </p>
