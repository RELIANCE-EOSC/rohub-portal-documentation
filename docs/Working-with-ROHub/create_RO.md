...
Filling the basic information is sufficient to create a RO in the ROHub platform, but the user can continue enriching the RO with other metadata or simply create the basic RO and exit by clicking "Create and Exit" . On clicking “Create and Continue '' present at the bottom right of this page the user can create the RO and also simultaneously navigate through other forms to add the various relevant metadata in order to enrich the research object. The user can always return to edit the metadata of the newly created RO listed in the "My ROs" section and also in the "Explore" page. "Reset form" allows the user to reset the basic information form and provide inputs again.
